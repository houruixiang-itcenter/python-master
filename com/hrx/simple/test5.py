...
#  todo test--利用Python内置的hex()函数把一个整数转换成十六进制表示的字符串：
print('调用函数test: ', hex(10))
...
print('定义函数test: ', command.quadratic(2, 3, 1))
...
# todo 定义函数的test
# todo 请编写move(n, a, b, c)函数，它接收参数n，
# todo 表示3个柱子A、B、C中第1个柱子A的盘子数量，然后打印出把所有盘子从A借助B移动到C的方法
print('递归函数test: ', command.hnt_move(3, 'A', 'B', 'C'))
