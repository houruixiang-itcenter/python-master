...
# todo  python中的偏函数 对等之前提到的默认参数 只不过是通过 functools.partial就是帮助我们创建一个偏函数的
# 比如通过int函数 把目标值转化为 十进制   base 代表当前value是几进制
print(int('1234', base=8))

# 使用偏函数
f_int = functools.partial(int, base=8)
print(f_int('1234'))
